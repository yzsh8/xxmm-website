...
$(function() {
  for (var i = 0; i < $("div[name=ee]").length; i++) {
            ...
            if (m.text().length > 170) {
                m.attr("ee", m.text());
                m.html(m.text().substr(0, 170) + "...<a name=\"zhankai\" class=\"y\" href=\"javascript:;\">更多</a>");
            }
        }
        $("a[name=zhankai]").live("click", function () {
            $(this).parent().html($(this).parent().attr("ee") + "<a name=\"yinchang\" class=\"y\" href=\"javascript:;\">展开</a>");
        });
        $("a[name=yinchang]").live("click", function () {
            $(this).parent().html($(this).parent().attr("ee").substr(0, 170) + "...<a name=\"zhankai\" class=\"y\" href=\"javascript:;\">隐藏</a>");
        });
 });
$(function(){
    $(".sbtn").click(function(){
...
function Order(o,id,vi){
    ...
    if (o==1){
      ...
      s1="<em class=\"over\">鍊掑簭鈫�</em>"
      s2="<em onclick=\"Order(0,'vlink_"+vi+"',"+vi+")\">椤哄簭鈫�</em>"
    }else{
      for(i=leng-1;i>=0;i--){
          if(i==0){isno='<li class="new">';}else{isno='<li>';}
          uhtml+=isno+tag[i].innerHTML+"</li>";
      }
      s1="<em onclick=\"Order(1,'vlink_"+vi+"',"+vi+")\">鍊掑簭鈫�</em>"
      s2="<em class=\"over\">椤哄簭鈫�</em>"
    }
    $$(id+"_s1").innerHTML=s1;
    $$(id+"_s2").innerHTML=s2;
    uhtml="<ul>"+uhtml+"</ul>";
